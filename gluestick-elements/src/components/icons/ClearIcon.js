...
const ClearIcon = ({className}) => (
    <svg className={className} width="100%" height="100%" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg" style={{fillRule:"evenodd",clipRule:"evenodd",strokeLinejoin:"round",strokeMiterlimit:2}}>
        ...
        <path d="M14.25,4.808L13.192,3.75L9,7.943L4.808,3.75L3.75,4.808L7.943,9L3.75,13.192L4.808,14.25L9,10.058L13.192,14.25L14.25,13.192L10.058,9L14.25,4.808Z" style={{fill:"rgb(85,90,100)",fillRule:"nonzero"}}/>
    </svg>
)
