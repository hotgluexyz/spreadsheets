        ...
        <nav className="navbar navbar-expand-lg navbar-light" data-sticky="top">
            ...
            <Link href="/">
                <a className="navbar-brand navbar-brand-dynamic-color fade-page">
                    <img alt="gluestick" src={require("../assets/img/gluestick.svg")} className="header-logo"/>
                </a>
            </Link>
            <div className="d-flex align-items-center order-lg-3">
                <a href="https://github.com/hotgluexyz/gluestick" className="btn btn-primary ml-lg-4 mr-3 mr-md-4 mr-lg-0 d-none d-sm-block order-lg-3">View on GitHub</a>
            </div>
            <div className="collapse navbar-collapse order-3 order-lg-2 justify-content-lg-end" id="navigation-menu">
                ...
                <li className="nav-item">
                    <a className="nav-link nav-item" href="https://docs.gluestick.xyz" role="button">Docs</a>
                </li>
                </ul>
            </div>
            </div>
